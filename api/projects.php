...
<div class="mt-5 text-center ">
    <div class="flex justify-center items-center px-4">
        ...
        <a class="rounded-2xl bg-blue-900 hover:bg-blue-900 text-white hover:text-red-200 px-6 py-3 mx-2" href="./projects.php">Projects</a>
        <a class="rounded-2xl bg-blue-700 hover:bg-blue-900 text-blue-200 hover:text-red-200 px-6 py-3 mx-2" href="./">Home</a>
        <form method="post">
